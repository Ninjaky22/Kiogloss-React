                ...
                <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">
                  <div className="flex gap-2">
                    <button
                      ...
                      className="bg-green-600 text-white hover:bg-green-500 rounded-lg px-4 py-2 transition flex items-center gap-2">Editar</button>
                    <button className="bg-red-600 text-white hover:bg-red-500 rounded-lg px-4 py-2 transition flex items-center gap-2" onClick={()=>{
                      if(producto.id) handleDeleteProducto(producto.id)
                    }} disabled={producto.id? false: true}>Eliminar</button>
                  </div>
                </TableCell>
              </TableRow>
            ))}
